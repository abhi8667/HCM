...
\hline
\centering Ashwin Thammaiah K &
\centering Dr. Sudarshan B.G \tabularnewline
...
\textbf{Ashwin Thammaiah K}\\
Faculty Mentor
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
\raggedleft
\textbf{Dr.Sudarshan B.G}\\
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{slider.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{hm.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{cp.png}
...
\item[] 
The 11-residue $(size, 
charge)$ encoding used in Phase~II, while
