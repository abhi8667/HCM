...
{\LARGE\textbf{EXPERIENTIAL LEARNING}}\\
Academic Year 2025--26

\vspace{0.5cm}

{\large\textbf{Health,Wellness\&Traditional Medicine}}

\vspace{1cm}

{\Large\textbf{Phase II Progress Report}}\\[0.3cm]
{\LARGE\textbf{Unbiased Machine Learning for HCM: Utilizing Standing Variation to Reclassify Variants of Uncertain Significance
}}
...
\hline
\textbf{Sl. No.} & \textbf{USN} & \textbf{Name} & \textbf{Program} \\
\hline
1 & 1RV25IM002 & Adhar Chaudhari       & IM   \\
2 & 1RV25CV002 & Abhinandan Jaiswal    & CV   \\
3 & 1RV25CS & Tejash Pathak            & CS   \\
4 & 1RV25CS & Ekansh Nandan Sharma     & CS   \\
\hline
\end{tabular}
...
\hline
\centering\textbf{Faculty Mentor} &
\centering\textbf{Chief Faculty Mentor}\tabularnewline
\hline
\centering Ashwin &
\centering Dr. Sudarshan \tabularnewline
\centering Assistant Professor &
\centering Professor \tabularnewline
\hline
\end{tabular}
...
{\Large\textbf{Phase II Progress Report}}\\
{\Large\textbf{HCM Variant Pathogenicity Classification}}
...
\begin{tabular}{ll}
Abhinandan Jaiswal    & (1RV25CV002) \\
Adhar Chaudhari     & (1RV25IM002) \\
Ekansh Nandan Sharma  & (1RV25CS086) \\
Tejash Pathak & (1RV25CS007) \\
\end{tabular}

\vspace{0.8cm}

in fulfillment of the requirements for the completion of the

\textbf{Experiential Learning Project}
...
Date: 28-04-2026 \hfill Place: Bengaluru
...
Hypertrophic Cardiomyopathy (HCM) is the most prevalent inherited cardiac disorder, affecting approximately 1 in 500 individuals worldwide. Despite rapid advances in clinical genomic sequencing, a substantial proportion of identified missense variants remain classified as \emph{Variants of Uncertain Significance (VUS)}, creating a diagnostic gap that impedes genetic counselling and family-cascade screening.

This report presents the design, implementation, and comparative evaluation of a Phase II machine-learning framework for HCM variant pathogenicity prediction.

A dataset of \textbf{1,954 clinically annotated missense variants} spanning nine sarcomeric genes was curated using ClinVar, ClinGen, gnomAD, ExAC, TOPMed, dbSNP, and UniProt.

Three modelling streams were developed:

\begin{itemize}
\item Tuned XGBoost (Tabular Features)
\item 1D-CNN (Sequence Features)
\item Late-Fusion Hybrid Ensemble
\end{itemize}
...
\begin{itemize}
\item ROC-AUC = \textbf{0.8222}
\item MCC = \textbf{0.45}
\item Balanced Accuracy = \textbf{0.753}
\end{itemize}

These findings validate the complementarity of structured biochemical features and learned sequence representations.

\end{abstract}

\newpage

% Continue with your original sections from Introduction onward
% (Paste remaining content exactly below this point)
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{roc_comparison.png}
  \caption{ROC curves for all three experimental branches.}
  \label{fig:roc}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{pr_comparison.png}
...
distribution and whether its probability calibration (Figure~\ref{fig:calibration})
is reliable in a prospective clinical
setting.

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{calibration_plot.png}
\caption{Probability calibration curve for the Hybrid Ensemble.
         Reliability of predicted pathogenicity probabilities across
         the full $[0,1]$ range is required for prospective clinical use.}
