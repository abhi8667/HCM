...
\begin{align}
\text{Recall (Benign)}     &= \frac{TN}{TN + FP} = \frac{398}{513}  = 0.776 \label{eq:rec_b}\\
\text{Recall (Pathogenic)} &= \frac{TP}{TP + FN} = \frac{1052}{1441} = 0.730 \label{eq:rec_p}\\
\text{Precision (Benign)}  &= \frac{TN}{TN + FN} = \frac{398}{787}  = 0.506 \label{eq:prec_b}
\end{align}
